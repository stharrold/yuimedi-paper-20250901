---
type: claude-context
directory: planning/reference-validation
purpose: BMAD planning documents for reference validation feature
parent: ../CLAUDE.md
...
# Claude Code Context: reference-validation Planning

## Purpose

BMAD planning documents for the reference-validation feature. Created during Phase 1 (Planning) in main repository on contrib branch.
...
1. SpecKit auto-detects this planning directory: `../planning/reference-validation/`
...
- **[README.md](README.md)** - Human-readable overview of reference-validation planning
