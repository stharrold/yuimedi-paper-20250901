---
type: claude-context
directory: planning/fix-broken-url-hrefs
purpose: BMAD planning documents for fix-broken-url-hrefs feature
parent: ../CLAUDE.md
...
# Claude Code Context: fix-broken-url-hrefs Planning

## Purpose

BMAD planning documents for the fix-broken-url-hrefs feature. Created during Phase 1 (Planning) in main repository on contrib branch.

## Directory Structure

```
planning/fix-broken-url-hrefs/
...
1. SpecKit auto-detects this planning directory: `../planning/fix-broken-url-hrefs/`
...
- **[README.md](README.md)** - Human-readable overview of fix-broken-url-hrefs planning
