---
type: claude-context
directory: planning/pdf-generation-pipeline
purpose: BMAD planning documents for PDF generation pipeline feature
...
# Claude Code Context: pdf-generation-pipeline Planning

## Purpose

BMAD planning documents for the pdf-generation-pipeline feature. Created during Phase 1 (Planning) in main repository on contrib branch.

## Directory Structure

```
planning/pdf-generation-pipeline/
...
1. SpecKit auto-detects this planning directory: `../planning/pdf-generation-pipeline/`
...
- **[README.md](README.md)** - Human-readable overview of pdf-generation-pipeline planning
