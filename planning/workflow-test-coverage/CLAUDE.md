---
type: claude-context
directory: planning/workflow-test-coverage
purpose: BMAD planning documents for workflow test coverage feature
parent: ../CLAUDE.md
...
# Claude Code Context: workflow-test-coverage Planning

## Purpose

BMAD planning documents for the workflow-test-coverage feature. Created during Phase 1 (Planning) in main repository on contrib branch.

## Directory Structure

```
planning/workflow-test-coverage/
...
1. SpecKit auto-detects this planning directory: `../planning/workflow-test-coverage/`
...
- **[README.md](README.md)** - Human-readable overview of workflow-test-coverage planning
