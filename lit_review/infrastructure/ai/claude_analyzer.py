...
Implements the AIAnalyzer port using the Anthropic Claude SDK
...
class ClaudeAnalyzer(AIAnalyzer):
    ...
    Uses Anthropic Claude API for theme extraction and synthesis when available.
...
"""
        ...
        response = self._client.messages.create(
            model=self.model,
            max_tokens=4096,
            system="You are an academic research analyst. Respond only with valid JSON, no markdown fencing.",
