# Specification: Repo Organization Cleanup
...
**BMAD Planning:** See `planning/repo-organization-cleanup/` for complete requirements and architecture.
...
See: `planning/repo-organization-cleanup/requirements.md` in main repository
