...
**Before v5.2:**
- Claude Code reproduces planning Q&A each time (~2,500 tokens)
- Claude Code reproduces spec generation each time (~2,000 tokens)
...
**Implementation key:** Scripts run interactively in main context, Claude Code doesn't reproduce logic
...
```
directory/
├── CLAUDE.md          # Context for Claude Code (with YAML frontmatter)
