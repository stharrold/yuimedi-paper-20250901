...
- Author names were corrected against publisher records in 15 entries (including wrong or incomplete given names and missing co-authors), and bibliographic fields (volume, issue, pages) were completed throughout.
