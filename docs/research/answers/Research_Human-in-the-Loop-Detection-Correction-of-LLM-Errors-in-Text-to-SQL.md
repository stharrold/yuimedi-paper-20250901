...
- *Quantified HITL gain over end-to-end LLM.* Benzarti & Berrabah (Springer, 2025) report a 28.4% improvement in semantic correctness over end-to-end LLM approaches via a validation-gate mechanism where experts review/modify generated SQL before execution.
...
| 2 | Benzarti S, Berrabah C. Generative AI for Intelligent Data Extraction: A Case Study in Automated Excel-to-SQL with Human Oversight. | Springer (EAI Intl. Conf.), 2025 | https://link.springer.com/chapter/10.1007/978-3-032-16638-8_11 | Validation-gate HITL; +28.4% semantic correctness over end-to-end LLM |
