...
| Question | Scope | Research File |
|----------|-------|---------------|
| What algorithms exist for automatic PK/FK discovery from database metadata? | Paper2 | [`Research_What-algorithms-exist-for-automatic-primary-foreign-key-discovery-from-database-metadata.md`](Research_What-algorithms-exist-for-automatic-primary-foreign-key-discovery-from-database-metadata.md) |
| How do existing approaches validate discovered relationships (precision/recall)? | Paper2 | [`Research_How-do-existing-approaches-validate-discovered-database-relationships-precision-recall.md`](Research_How-do-existing-approaches-validate-discovered-database-relationships-precision-recall.md) |
| Has schema discovery been applied to healthcare databases specifically? | Paper2 | [`Research_has-schema-discovery-been-applied-to-healthcare-databases-specifically.md`](Research_has-schema-discovery-been-applied-to-healthcare-databases-specifically.md) |
...
|----------|-------|--------|-------|
| How have vector embeddings been used for schema matching or column selection? | Paper2 | Partial | [`Research_How-have-vector-embeddings-been-used-for-schema-matching-or-column-selection.md`](Research_How-have-vector-embeddings-been-used-for-schema-matching-or-column-selection.md) |
| What is the state of the art in semantic table/column matching for NL2SQL? | Paper2 | Unanswered | |

### Knowledge Management Theory

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| How does Nonaka's SECI model apply to organizational knowledge capture in analytics? | Paper1,Paper2 | Unanswered | Follow-up: How have others operationalized tacit-to-explicit knowledge conversion in software systems? |

### Institutional Learning and Query Reuse

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| How have others measured institutional learning in analytics or BI systems? | Paper2 | Unanswered | |
| Have any NL2SQL systems implemented query memoization or caching? | Paper2 | Unanswered | |
| How have others measured efficiency gains from query reuse in database systems? | Paper2 | Unanswered | |

### Healthcare Terminology Mapping

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| What approaches exist for programmatic mapping to SNOMED, LOINC, RxNorm? | Paper3 | Unanswered | |
| What is the reported ETL burden for OMOP/FHIR transformation? | Paper3 | Unanswered | |

### Healthcare Implementation Efficiency Evidence

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| What quantitative efficiency metrics (time savings, task completion rates) have been reported for low-code or conversational AI in healthcare? | Paper1 | → Gap | Added to paper.md "Gaps in Current Literature" |
| What peer-reviewed (non-vendor-sponsored) evidence exists for cost reductions from healthcare AI/low-code implementations? | Paper1 | Unanswered | |
| How have healthcare organizations measured productivity gains from NL2SQL vs. traditional SQL workflows? | Paper1,Paper2 | Unanswered | |
| What methodology has been used to measure "citizen developer" productivity in healthcare contexts? | Paper1 | Unanswered | |

### Clinical Safety and Security

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| What clinical safety considerations apply to AI-assisted healthcare analytics? | Paper2,Paper3 | Unanswered | |
| What security architecture patterns exist for NL2SQL systems handling PHI? | Paper2 | Unanswered | |
| How do NIST, HITRUST, and HIPAA requirements apply to AI-enabled healthcare systems? | Paper2,Paper3 | Unanswered | |

### Synthetic Data and Validation

| Question | Scope | Status | Notes |
|----------|-------|--------|-------|
| How has Synthea synthetic data been used for healthcare AI/NL2SQL validation? | Paper2 | Unanswered | |
| What cloud architecture patterns exist for reproducible NL2SQL benchmarking? | Paper2 | Unanswered | |
| How have others validated NL2SQL systems on synthetic vs. real clinical data? | Paper2 | Unanswered | |
