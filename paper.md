...
version: "1.19.0"
abstract: |
  **Background:** Healthcare organizations face three interconnected challenges that form a compounding cycle: low analytics maturity (only 39 organizations globally have achieved HIMSS AMAM Stage 6-7), high new-hire turnover (~34% implied annual rate for healthcare IT staff as of 2004), and technical barriers in natural language to SQL generation. When these challenges interact, they create institutional memory loss that threatens data-driven healthcare transformation.
...
- **Dated workforce statistics**: The primary healthcare IT turnover statistic (~34% implied for new hires) derives from Ang and Slaughter's 2004 study [@ang2004]. While recent surveys confirm workforce challenges persist [@american2023] and contemporary evidence suggests the situation may have worsened (55% intent to leave among public health informatics specialists [@rajamani2025]), no study has directly replicated the 2004 tenure measurement methodology. Future research should address this methodological gap
...
Technical and analytics staff face even more severe turnover challenges. In their 2004 study, Ang and Slaughter [@ang2004] found that IT professionals at healthcare provider institutions (where IT serves as a support function rather than core business) had an expected tenure of just 2.9 years for new hires, implying an effective turnover rate of ~34% for the incoming talent required to modernize capabilities. This creates a "revolving door" for innovation-focused staff, significantly higher than the 15.5% general turnover rate reported for the broader workforce, and compares unfavorably to the 9.68-year average tenure for IT managerial positions. While this data is now two decades old, contemporary evidence suggests the turnover challenge persists or has worsened. A 2025 analysis of nationally representative US survey data (n=44,732) found that 55% of public health informatics specialists intended to leave their positions [@rajamani2025]. The 2023 AHIMA/NORC workforce survey found that 66% of health information professionals report persistent staffing shortages, with 83% witnessing increased unfilled positions over the past year [@american2023].
