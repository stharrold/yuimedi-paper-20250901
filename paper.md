...
3. **Validation**: The domain expert reviews the generated SQL and its results, confirming correctness or providing corrections. This human-in-the-loop step is essential because current NL2SQL models are "not yet sufficiently accurate for unsupervised use" in clinical settings [@ziletti2024].
