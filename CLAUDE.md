...
- **Sweep for stale library paths** (0 as of 2026-09-15; `ARCHIVED/` snapshots deliberately excluded): `git grep -n -o -E '\.\./library/docs/[A-Za-z0-9_./-]+\.pdf' -- ':!ARCHIVED' | perl -ne 'chomp; ($f,$l,$p)=split(/:/,$_,3); print "$f:$l $p\n" unless -e $p'`
