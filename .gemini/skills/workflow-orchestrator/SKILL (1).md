...
2. Create .gemini/skills/ directory structure
3. Generate workflow files (WORKFLOW.md, GEMINI.md, README.md)
...
def check_context_usage(current_tokens):
    ...
    if current_tokens >= CHECKPOINT_THRESHOLD:
        ...
        print("\n🔄 REQUIRED ACTIONS:")
        print("  1. Run: /init (updates GEMINI.md memory files)")
...
- Updating GEMINI.md memory files with current state
