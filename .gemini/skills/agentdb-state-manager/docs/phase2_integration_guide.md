...
**Implementation location**: `.gemini/skills/agentdb-state-manager/scripts/worktree_agent_integration.py`
...
**File to modify**: `.gemini/skills/agentdb-state-manager/scripts/sync_engine.py` (replace `_detect_phi()` method)
